...
plot(nCPq[,3]~libs,type="l",col="red",ylim=c(0.1,0.6),lwd=2,
...
# Design a sequence of library size
libs <- c(seq(E_ccm_FChnk*1.5,57,2))
...
legend(25,0.25,c("Fall Chinook xmap PDO","PDO xmap Fall Chinook"),lty=c(1,1),col=c("red","blue"))
...
# Design a sequence of library size
libs <- c(seq(E_FChnk_ccmE_SL*1.5,40,2))
...
# Plot forecast skill vs library size
# Fall Chinook cross-mapping sealion pup count (i.e. testing sea lion pup count as a cause of Fall chinook)
plot(nFC_SLq[,3]~libs,type="l",col="red",ylim=c(0.5,0.9),lwd=2,
     main="Convergent cross mapping CCM",xlab="Library size",ylab=expression(rho)) # median predictive skill vs library size (or we can use mean predictive skill)
...
# Design a sequence of library size
libs <- c(seq(E_SL_ccmE_FChnk*1.5,40,2))
...
legend(15,0.6,c("Fall Chinook xmap sea lion pup count","Sea lion pup count xmap Fall Chinook"),lty=c(1,1),col=c("red","blue"))
#abline(h=cor(dat[,'FChnk'],dat[,'PDO']),lty=3)
...
# Design a sequence of library size
libs <- c(seq(E_FChnk_ccmE_SLM,40,2))
...
legend(22,0.80,c("Fall Chinook xmap male sea lion","Male sea lion xmap Fall Chinook"),lty=c(1,1),col=c("red","blue"))
#abline(h=cor(dat[,'FChnk'],dat[,'PDO']),lty=3)
...
# Design a sequence of library size
libs <- c(seq(E_FChnk_ccmE_orca*1.5,43,2))
...
plot(nFC_orcaq[,3]~libs,type="l",col="red",ylim=c(0.4,0.9),lwd=2,
     main="Convergent cross mapping CCM",xlab="Library size",ylab=expression(rho)) # median predictive skill vs library size (or we can use mean predictive skill)
...
# Design a sequence of library size
libs <- c(seq(E_orca_ccmE_FChnk*1.5,43,2))
...
legend(22,0.55,c("Fall Chinook xmap SR orcas","SR orcas xmap Fall chinook"),lty=c(1,1),col=c("red","blue"))
#abline(h=cor(dat[,'FChnk'],dat[,'PDO']),lty=3)
...
plot(nCPq[,3]~libs,type="l",col="red",ylim=c(0.05,0.65),lwd=2,
     main="Convergent cross mapping CCM",xlab="Library size",ylab=expression(rho)) # median predictive skill vs library size (or we can use mean predictive skill)
lines(nCPq[,2]~libs,col="red",lwd=1,lty=2) # 1st quantile 
lines(nCPq[,4]~libs,col="red",lwd=1,lty=2) # 3rd quantile
...
# Design a sequence of library size
libs <- c(seq(E_ccm_SChnk*1.5,57,2))
...
lines(nPCq[,2]~libs,col="blue",lwd=1,lty=2) # 1st quantile 
lines(nPCq[,4]~libs,col="blue",lwd=1,lty=2) # 3rd quantile
legend(30,0.2,c("S/S Chinook cross-mapping PDO","PDO cross-mapping S/S Chinook"),lty=c(1,1),col=c("red","blue"))
...
# Design a sequence of library size
libs <- c(seq(E_SChnk_ccmE_SL*1.5,40,2))
...
# Plot forecast skill vs library size
# Spring/Summer Chinook cross-mapping sealion pup count (i.e. testing sea lion pup count as a cause of S/S chinook)
plot(nSC_SLq[,3]~libs,type="l",col="red",ylim=c(0.4,0.7),lwd=2,
     main="Convergent cross mapping CCM",xlab="Library size",ylab=expression(rho)) # median predictive skill vs library size (or we can use mean predictive skill)
...
# Design a sequence of library size
libs <- c(seq(E_SL_ccmE_SChnk*1.5,40,2))
...
legend(20,0.49,c("S/S Chinook xmap sea lion pup count","Sea lion pup count xmap S/S Chinook"),lty=c(1,1),col=c("red","blue"))
#abline(h=cor(dat[,'SChnk'],dat[,'PDO']),lty=3)

```
Non-significant effects between sea lion pup-count and S/S Chinook
...
# Design a sequence of library size
libs <- c(seq(E_SChnk_ccmE_SLM*1.5,40,2))
...
# Design a sequence of library size
libs <- c(seq(E_SLM_ccmE_SChnk*1.5,40,2))
...
# Design a sequence of library size
libs <- c(seq(E_SChnk_ccmE_orca*1.5,43,2))
...
# Design a sequence of library size
libs <- c(seq(E_orca_ccmE_SChnk*1.5,43,2))
...
```{r}
# Orca cross-mapping sea lion pup counts (i.e. testing sea lion pup as a cause of Orca dynamics)
SRKW <- NULL
SRKW$Male <- sealion.csv$Male[which(sealion.csv$Year>1975 & sealion.csv$Year<2015)]
SRKW$Pup <- sealion.csv$Pup.count[which(sealion.csv$Year>1975 & sealion.csv$Year<2015)]
...
# Design a sequence of library size
libs <- c(seq(E_SR_Orca_ccmE_SLM*1.5,40,2))
...
# Design a sequence of library size
libs <- c(seq(E_SLM_ccmE_SR_Orca*1.5,40,2))
...
E.test=NULL
for(E.t in 2:8){
  E.temp <- ccm(SRKW, E = E.t, lib_column = "SR_Orca", target_column = "Pup", lib_sizes = 40, num_samples = 1, tp=-1,random_libs = F)
  E.test=rbind(E.test,E.temp)}
E_SR_Orca_ccmE_SLP <- E.test$E[which.max(E.test$rho)[1]] # the optimal E

# Design a sequence of library size
libs <- c(seq(E_SR_Orca_ccmE_SLP*1.5,40,2))

# CCM analysis with varying library size (L)
SR_Orca_ccm_SLP <- ccm(SRKW, E=E_SR_Orca_ccmE_SLP,lib_column="SR_Orca", target_column="Pup",
                lib_sizes=libs, num_samples=100, replace=T, RNGseed=2301)
	
# Calculate the median, maximum, and 1st & 3rd quantile of rho for each L
nKW_SLPq=as.matrix(aggregate(SR_Orca_ccm_SLP[,c('rho')],by = list(as.factor(SR_Orca_ccm_SLP$lib_size)), quantile)[,'x'])
apply(nKW_SLPq[,2:5],2,MannKendall)

# Plot forecast skill vs library size
# Orca cross-mapping male sea lion estimates (i.e. testing male sea lion estimates as a cause of Orca dynamics)

plot(nKW_SLPq[,3]~libs,type="l",col="red",ylim=c(0.2,0.9),lwd=2,
     main="Convergent cross mapping CCM",xlab="Library size",ylab=expression(rho)) # median predictive skill vs library size (or we can use mean predictive skill)
lines(nKW_SLPq[,2]~libs,col="red",lwd=1,lty=2) # 1st quantile 
lines(nKW_SLPq[,4]~libs,col="red",lwd=1,lty=2) # 3rd quantile
...
E.test=NULL
for(E.t in 2:8){
  E.temp <- ccm(SRKW, E = E.t, lib_column = "Pup", target_column = "SR_Orca", lib_sizes = 40, num_samples = 1, tp=-1,random_libs = F)
  E.test=rbind(E.test,E.temp)}
E_SLP_ccmE_SR_Orca <- E.test$E[which.max(E.test$rho)[1]] # the optimal E

# Design a sequence of library size
libs <- c(seq(E_SLP_ccmE_SR_Orca*1.5,40,2))

# CCM analysis with varying library size (L)
SLP_ccm_SR_Orca <- ccm(SRKW, E=E_SLP_ccmE_SR_Orca,lib_column="Pup", target_column="SR_Orca",
                lib_sizes=libs, num_samples=100, replace=T, RNGseed=2301)
	
# Calculate the median, maximum, and 1st & 3rd quantile of rho for each L
nSLP_KWq=as.matrix(aggregate(SLP_ccm_SR_Orca[,c('rho')],by = list(as.factor(SLP_ccm_SR_Orca$lib_size)), quantile)[,'x'])
apply(nSLP_KWq[,2:5],2,MannKendall)

# Male sea lion cross-mapping Orcas (i.e. testing Orcas as a cause of male sea lions)
lines(nSLP_KWq[,3]~libs,col="blue",lwd=1,lty=1) # median 
lines(nSLP_KWq[,2]~libs,col="blue",lwd=1,lty=2) # 1st quantile 
lines(nSLP_KWq[,4]~libs,col="blue",lwd=1,lty=2) # 3rd quantile
legend(25,0.4,c("Orca xmap sea lion pup count","Sea lion pup count xmap Orca"),lty=c(1,1),col=c("red","blue"))
#abline(h=cor(dat[,'SChnk'],dat[,'PDO']),lty=3)

```
Significant effect of Orcas on sea lion pup count but not of pup counts on orcas. 
...
# Design a sequence of library size
libs <- c(seq(E_PDO_ccmE_SL*1.5,40,2))
...
# Design a sequence of library size
libs <- c(seq(E_SL_ccmE_PDO*1.5,40,2))
...
E.test=NULL
for(E.t in 2:8){
  E.temp <- ccm(sealion.csv, E = E.t, lib_column = "PDO", target_column = "Male", lib_sizes = 40, num_samples = 1, tp=-1,random_libs = F)
  E.test=rbind(E.test,E.temp)}
E_PDO_ccmE_SLM <- E.test$E[which.max(E.test$rho)[1]] # the optimal E

# Design a sequence of library size
libs <- c(seq(E_PDO_ccmE_SLM*1.5,40,2))

# CCM analysis with varying library size (L)
PDO_ccm_SLM <- ccm(sealion.csv, E=E_PDO_ccmE_SLM,lib_column="PDO", target_column="Male",
                lib_sizes=libs, num_samples=100, replace=T, RNGseed=2301)
	
# Calculate the median, maximum, and 1st & 3rd quantile of rho for each L
nPDO_SLMq=as.matrix(aggregate(PDO_ccm_SLM[,c('rho')],by = list(as.factor(PDO_ccm_SLM$lib_size)), quantile)[,'x'])
apply(nPDO_SLMq[,2:5],2,MannKendall)

# Plot forecast skill vs library size
# PDO cross-mapping sealion (i.e. testing sea lions as a cause of PDO)
plot(nPDO_SLMq[,3]~libs,type="l",col="red",ylim=c(0.3,1),lwd=2,
     main="Convergent cross mapping CCM",xlab="Library size",ylab=expression(rho)) # median predictive skill vs library size (or we can use mean predictive skill)
lines(nPDO_SLMq[,2]~libs,col="red",lwd=1,lty=2) # 1st quantile 
lines(nPDO_SLMq[,4]~libs,col="red",lwd=1,lty=2) # 3rd quantile

###########################################################
# Sea lion male population cross-mapping PDO (i.e. testing PDO as a cause of sea lions male population)

# Determine the embedding dimension
E.test=NULL
for(E.t in 2:8){
  E.temp <- ccm(sealion.csv, E = E.t, lib_column = "Male", target_column = "PDO", lib_sizes = 40, num_samples = 1, tp=-1,random_libs = F)
  E.test=rbind(E.test,E.temp)}
E_SLM_ccmE_PDO <- E.test$E[which.max(E.test$rho)[1]] # the optimal E

# Design a sequence of library size
libs <- c(seq(E_SLM_ccmE_PDO*1.5,40,2))

# CCM analysis with varying library size (L)
SLM_ccm_PDO <- ccm(sealion.csv, E=E_SLM_ccmE_PDO,lib_column="Male", target_column="PDO",
                lib_sizes=libs, num_samples=100, replace=T, RNGseed=2301)
	
# Calculate the median, maximum, and 1st & 3rd quantile of rho for each L
nSLM_PDOq=as.matrix(aggregate(SLM_ccm_PDO[,c('rho')],by = list(as.factor(SLM_ccm_PDO$lib_size)), quantile)[,'x'])
apply(nSLM_PDOq[,2:5],2,MannKendall)


# Sea lion male population cross-mapping PDO (i.e. testing PDO as a cause of sea lions male population)

lines(nSLM_PDOq[,3]~libs,col="blue",lwd=1,lty=1) # median 
lines(nSLM_PDOq[,2]~libs,col="blue",lwd=1,lty=2) # 1st quantile 
lines(nSLM_PDOq[,4]~libs,col="blue",lwd=1,lty=2) # 3rd quantile
legend(18,0.75,c("PDO xmap male sea lions","Male sea lion xmap PDO"),lty=c(1,1),col=c("red","blue"))
#abline(h=cor(dat[,'PDO'],dat[,'PDO']),lty=3)
```
...
# Design a sequence of library size
libs <- c(seq(E_PDO_ccmE_orca*1.5,43,2))
...
# Design a sequence of library size
libs <- c(seq(E_orca_ccmE_PDO*1.5,43,2))
...
legend(20,0.4,c("PDO cross-mapping orcas","Orcas cross-mapping PDO"),lty=c(1,1),col=c("red","blue"))
#abline(h=cor(dat[,'PDO'],dat[,'PDO']),lty=3)

```
Both are significantly increasing, but only the effect of PDO on Orcas is significantly different from zero. 
```{r}
...
# Design a sequence of library size
libs <- c(seq(E_FChnk_ccmE_SChnk*1.5,57,2))
...
# Plot forecast skill vs library size
# Fall Chinook cross-mapping Spring/Summer Chinook (i.e. testing S/S Chinook as a cause of Fall chinook)
plot(nFC_SCq[,3]~libs,type="l",col="red",ylim=c(0.55,0.9),lwd=2,
     main="Convergent cross mapping CCM",xlab="Library size",ylab=expression(rho)) # median predictive skill vs library size (or we can use mean predictive skill)
...
# Design a sequence of library size
libs <- c(seq(E_SChnk_ccmE_FChnk*1.5,57,2))
...
legend(20,0.6,c("Fall Chinook xmap Spring/Summer Chinook","Spring/Summer Chinook xmap Fall Chinook"),lty=c(1,1),col=c("red","blue"))

```
Significant effect of S/S chinook on Fall Chinook but not vice-versa. 
...
d[,2] <- PDO.csv$PDOya[which(PDO.csv$Year>1975 & PDO.csv$Year<2015)]
d[,3] <- SRKW.csv$SR_Orca[which(SRKW.csv$Year<2015)]
d[,4] <- sealion.csv$Male[which(sealion.csv$Year>1975 & sealion.csv$Year<2015)]
d[,5] <- dat$SChnk[which(IHR_SprSum_Chinook.csv$year>1975 & IHR_SprSum_Chinook.csv$year<2015)]
#d[,2] <- dat$FChnk[which(IHR_Fall_Chinook.csv$year>1970 & IHR_Fall_Chinook.csv$year<2010)]



colnames(d) <-  c("FC","PDO", "KW", "SLM", "SC") 
...
plot(coeff[trange,"t"],coeff[trange,"dFCdFC"],type="l",col="green",xlab="time", 
     ...
     ylim=c(-0.9,1),xlim=range(trange),lwd=2)
abline(a=0 ,b=0 , lty="dashed", col="black", lwd=.5)

lines(coeff[trange,"dFCdSC"],type="l",col="blue",lwd=2)
lines(coeff[trange,"dFCdPDO"],type="l",col="red",lwd=2)
lines(coeff[trange,"dFCdKW"],type="l",col="black",lwd=2)
lines(coeff[trange,"dFCdSLM"],type="l",col="magenta",lwd=2)
#lines(coeff[trange,"dFCdFC-5"],type="l",col="cyan",lwd=2)


legend(0,-0.3,c(ylab=expression(partialdiff*FC / partialdiff*FC1),expression(partialdiff*FC / partialdiff*PDO), expression(partialdiff*FC / partialdiff*SRKW)),lty=c(1,1),col=c("green","red","black"))
legend(12,-0.3,c(ylab=expression(partialdiff*FC / partialdiff*SLM), expression(partialdiff*FC / partialdiff*SC)),lty=c(1,1),col=c("magenta", "blue"))
```
...
```
```{r}
qL <- rq(coeff$dFCdFC ~ coeff$dFCdSLM,alpha=0.05,.05) 
qU <- rq(coeff$dFCdFC ~ coeff$dFCdSLM,alpha=0.05,.95)
plot(coeff[1:l, 'dFCdSLM' ],coeff[1:l, 'dFCdFC' ], 
     xlab=expression(partialdiff*FC / partialdiff*SLM), 
     ylab=expression(partialdiff*FC / partialdiff*FC1), 
     xlim=range(coeff[trange,"dFCdSLM"]),ylim=range(coeff[trange,"dFCdFC"]),pch=8)
abline(a=qL$coefficients[1],b=qL$coefficients[2],lty=2,col='red',lwd=2)
abline(a=qU$coefficients[1],b=qU$coefficients[2],lty=2,col='red',lwd=2)
abline(a=0,b=0,lty=1,col='grey',lwd=2) #zero line
```
```{r}
qL <- rq(coeff$dFCdSLM ~ coeff$dFCdPDO,alpha=0.05,.05) 
qU <- rq(coeff$dFCdSLM ~ coeff$dFCdPDO,alpha=0.05,.95)
plot(coeff[1:l, 'dFCdPDO' ],coeff[1:l, 'dFCdSLM' ], 
     xlab=expression(partialdiff*FC / partialdiff*PDO), 
     ylab=expression(partialdiff*FC / partialdiff*SLM), 
     xlim=range(coeff[trange,"dFCdPDO"]),ylim=range(coeff[trange,"dFCdSLM"]),pch=8)
abline(a=qL$coefficients[1],b=qL$coefficients[2],lty=2,col='red',lwd=2)
abline(a=qU$coefficients[1],b=qU$coefficients[2],lty=2,col='red',lwd=2)
abline(a=0,b=0,lty=1,col='grey',lwd=2) #zero line
```
