...
rec5_spider <- data.frame(rbind(rep(1,4), rep(0,4), 
...
unique(rec5_ESU$FP)
rec5_ESU$FP = factor(rec5_ESU$FP, levels=c('upw.tdmi.5',
                                                           'pdo.spr.2',
                                                           'arc.win.2',
                                                           'npgo.win.3'))
...
# STOPPED HERE REPLACING REC4 WITH REC5
