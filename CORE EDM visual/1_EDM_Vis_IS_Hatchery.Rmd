...
p.viol <- ggplot(dat, aes(x=offset, y=coeff, fill=offset)) + 
  geom_violin() + scale_fill_manual(values = pal) + 
  facet_wrap(~subcat)

ggsave(filename =         
 paste("~/Github/Coordinated-Recoveries-GitHub/CORE EDM visual/Presentation/Viol_Hatchery_coeffs_IM.pdf", sep = ""), plot = p.viol, width = 7, height = 9.5, units = "in") 
...
ggsave(filename =         
 paste("~/Github/Coordinated-Recoveries-GitHub/CORE EDM visual/Presentation/BOX_Hatchery_coeffs_IM.pdf", sep = ""), plot = p, width = 7, height = 9.5, units = "in") 
