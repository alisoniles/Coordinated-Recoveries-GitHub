---
title: "2_CCM_pairwise_causality"
author: "Alison Iles"
date: "7/2/2020"
...
To test whether pairwise causality exists between the environmental variables and the SRKW population data. Also to test all the lags for each environmental variable for biological interpretation and to determing the direction of causality. 
...
rownames(data)
      ...
      bb <- data.frame(c(aa[39:43], aa[56:61], aa[74:103], aa[105:108], aa[110:112], aa[114:NROW(aa)] ))
...
rownames(block) <- NULL
    library_vars <- c("salm.rec4_n", "salm.rec5_n")
    ...
    Etheta <- readRDS(file="Output/Rdata/best_E_theta_rho_recspn_ESU.RDS")
    Etheta <- Etheta[c(3:4),] 
...
saveRDS(CCM_outputlist, file = paste("Output/Rdata/CCM_tp.RDS", sep = ""), compress = FALSE)
```    
...
CCM_outputlist<- readRDS("Output/Rdata/CCM_tp.RDS")
