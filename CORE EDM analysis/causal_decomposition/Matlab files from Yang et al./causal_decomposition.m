...
if rnoise>0
    imfs1=eemd(s1,rnoise,nensemble,numImf)';
    imfs2=eemd(s2,rnoise,nensemble,numImf)';
else
    nensemble=1;
    imfs1=eemd(s1,rnoise,nensemble,numImf)';
    imfs2=eemd(s2,rnoise,nensemble,numImf)';
...
[ps,pd]=phasefcimf(imfs1,imfs2,imfsize);
...
for i=1:imfsize
   ...
   s1r=s1-imfs1(:,i);
   s2r=s2-imfs2(:,i);
   imfs1r=eemd(s1r,rnoise,nensemble,imfsize)';
   imfs2r=eemd(s2r,rnoise,nensemble,imfsize)';  
