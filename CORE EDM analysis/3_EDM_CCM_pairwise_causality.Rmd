...
p1 <- ggplot(d, aes(x=offset, y=rho)) +
    ...
    theme_bw() + 
    labs(title=paste(name, "MPG", sep=" "), subtitle = "Multivariate CCM (block_lnlp) with the number of spawners included", x="Offset", y=expression(paste("Cross-mapping correlation, ", {rho}))) +  
