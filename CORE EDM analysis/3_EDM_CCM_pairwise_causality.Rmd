...
## Univariate CCM from library var to target var   
      ...
      #*********** CCM function ***********
      ccm <-  ccm(ccm_block, lib = lib, E = E, tp = tp, lib_column = library_var, target_column = target_var, first_column_time = TRUE, lib_sizes = libsize, random_libs = TRUE, num_samples=100, replace=TRUE, RNGseed=2301, silent = TRUE)      
