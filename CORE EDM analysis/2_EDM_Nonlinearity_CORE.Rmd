...
pdf("Output/Figures/2_Nonlinearity/best_ET_MPG_ESU.pdf")
...
data <- rbind(stock_data$'Bear Valley Creek', 
              stock_data$'Big Creek', 
              stock_data$'Camas Creek', 
              stock_data$'Catherine Creek', 
              stock_data$'Chamberlain Creek', 
              stock_data$'East Fork Salmon River', 
              stock_data$'East Fork South Fork', 
              stock_data$'Grande Ronde Upper Mainstem', 
              stock_data$'Imnaha River', 
              stock_data$'Lemhi River', 
              stock_data$'Loon Creek', 
              stock_data$'Lostine Creek', 
              stock_data$'Marsh Creek', 
              stock_data$'Middle Fork Salmon River above Indian Creek', 
              stock_data$'Middle Fork Salmon River below Indian Creek', 
              stock_data$'Minam River', 
              stock_data$'North Fork Salmon River', 
              stock_data$'Pahsimeroi River', 
              stock_data$'Salmon River Lower Mainstem below Redfish Lake', 
              stock_data$'Salmon River Upper Mainstem above Redfish Lake', 
              stock_data$'Secesh River', 
              stock_data$'South Fork Salmon River Mainstem', 
              stock_data$'Sulphur Creek', 
              stock_data$'Tucannon River', 
              stock_data$'Valley Creek', 
              stock_data$'Wallowa River, Hurricane Creek, Bear Creek, and Lostine Rivers', 
              stock_data$'Wenaha River', 
              stock_data$'Yankee Fork')
...
## Run for each MPG separately and the whole ESU
level <- c("ESU", "Middle Fork Salmon", "Imnaha", "Upper Salmon")
levelname <- c("ESU", "MiddleForkSalmon", "Imnaha", "UpperSalmon") 
for(l in (1:4)){  #loop through the ESU and the different MPGs
  if(l==1){Dtemp <- data}
  if(l==2){Dtemp <- data[data$mpg==level[l],]}
  if(l==3){Dtemp <- data[data$mpg==level[l],]}
  if(l==4){Dtemp <- data[data$mpg==level[l],]}  
